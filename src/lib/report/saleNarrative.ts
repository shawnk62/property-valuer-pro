...
export function buildSaleNarrativePrompt(
  ...
  const system = `You are writing sales evidence notes for an Australian residential valuation report (QLD), matching Peterson / Phil sample style.
Write ONE compact note — ideally 1–2 short sentences, maximum about 45 words.
Style examples (match this brevity):
- "Lowset brick and tile, 4 bed 2 bath, 1 car, land 390 m², living 177 m², quieter elevated site. Overall superior to the subject."
- "3 bedroom, 1 bathroom, 1 car garage, in need of full renovation, land area 604 square metres, build area 171 square metres, inferior."
Rules:
