...
const TOC_ENTRIES: TocEntry[] = [
  ...
  { id: "sec-property", number: "2.", title: "Property Details", fields: ["prop_type_residential", "prop_type_commercial", "prop_type_industrial", "prop_type_rural", "prop_type_specialised", ...PROPERTY_PLANNING_FIELDS, "prop_address", "prop_suburb", "prop_state", "prop_postcode", "prop_lotplan", "prop_legal", "prop_title", "prop_parish", "prop_lga", "prop_owner", "prop_occupant"] },
  ...
  { id: "sec-site", number: "6.", title: "Site Details", fields: ["prop_sitearea", "prop_areaunit", "prop_dimensions", "prop_shape", "prop_lot_position", "topo", "land", "va", "va_surface", "fence", "exc", "prop_view", "svc_water_type", "svc_sewer_type", "svc_elec_type", "svc_storm_type", "svc_tel_type", "prop_flood"] },
  { id: "sec-improvements", number: "7.", title: "Improvements", fields: ["imp_design", "imp_lowset", "imp_storeys", "imp_yearbuilt", "imp_effage", "imp_quality", "imp_gla", "ext", "win_mat", "win_type", "win_glaze", "rc", "rd", "foundations", "floor_structure", "flr", "overall_cond"], narrativeKey: "improvements" },
