...
const TOC_ENTRIES: TocEntry[] = [
  ...
  { id: "sec-site", number: "6.", title: "Site Details", fields: ["prop_sitearea", "prop_areaunit", "prop_dimensions", "prop_shape", "prop_lot_position", "topo", "land", "va", "fence", "exc", "prop_view", "svc_water_type", "svc_sewer_type", "svc_elec_type", "svc_storm_type", "svc_tel_type", "prop_flood"] },
